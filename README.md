...
- CMD:
  ```bash
  "C:\pmd-bin-7.17.0\bin\pmd.bat" check -d "C:\Users\aluno\Desktop\nicole\henry\trab-final-spi-meninasmalvadas\Evasão360°\src" -R category/java/bestpractices.xml,category/java/codestyle.xml,category/java/errorprone.xml,category/java/performance.xml,category/java/security.xml -f html -r relatorio.html
  ```
